...
HmmParam.BinSize=0.010;%0.002; % time step of Markov chain
HmmParam.MinDur=0.03;   % min duration of an admissible state (s) in HMM DECODING
...
%Adrian  note: NumRuns  used to be 500.
tic
...
hmm_results=hmm.fun_HMM_decoding(spikes,hmm_bestfit,HmmParam,win_train,spikes_peak);
