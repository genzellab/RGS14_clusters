...
GC_bandpassed_veh = GC_bandpassed_veh(:,:);
GC_raw_veh = GC_broadband_veh(:,:);
I=cellfun(@isempty,GC_raw_veh(:,1));
I=not(I);
GC_raw_veh=GC_broadband_veh(I,:);
GC_bandpassed_veh = GC_bandpassed_veh(I,:);
...
GC_bandpassed_rgs = GC_bandpassed_rgs(:,:);
GC_raw_rgs = GC_broadband_rgs(:,:);
I=cellfun(@isempty,GC_raw_rgs(:,1));
I=not(I);
GC_raw_rgs=GC_broadband_rgs(I,:);
GC_bandpassed_rgs = GC_bandpassed_rgs(I,:);
...
%%
% Swap x_axis1 and x_axis2
temp_x = x_axis1;
x_axis1 = x_axis2;
x_axis2 = temp_x;

% Swap y_axis1 and y_axis2
temp_y = y_axis1;
y_axis1 = y_axis2;
y_axis2 = temp_y;

% Swap z_axis1 and z_axis2
temp_z = z_axis1;
z_axis1 = z_axis2;
z_axis2 = temp_z;
%% FOR VEH
% Temporary variables to hold the coordinates of c1
temp_x = x_axis2;
temp_y = y_axis2;
temp_z = z_axis2;% Cluster 4

temp2_x = x_axis4;
temp2_y = y_axis4;
temp2_z = z_axis4;% Cluster 4

x_axis4 = temp_x;    % c1's x becomes c2's x
y_axis4 = temp_y;    % c1's y becomes c2's y
z_axis4 = temp_z;    % c1's z becomes c2's z

x_axis2 = temp2_x;    % c1's x becomes c2's x
y_axis2 = temp2_y;    % c1's y becomes c2's y
z_axis2 = temp2_z;    % c1's z becomes c2's z
%
temp_x = x_axis2;
temp_y = y_axis2;
temp_z = z_axis2;% Cluster 4
...
temp2_x = x_axis1;
temp2_y = y_axis1;
temp2_z = z_axis1;% Cluster 4

x_axis1 = temp_x;    % c1's x becomes c2's x
y_axis1 = temp_y;    % c1's y becomes c2's y
z_axis1 = temp_z;    % c1's z becomes c2's z

x_axis2 = temp2_x;    % c1's x becomes c2's x
y_axis2 = temp2_y;    % c1's y becomes c2's y
z_axis2 = temp2_z;    % c1's z becomes c2's z

% % Perform the rotation for x, y, and z coordinates
% x_axis1 = x_axis3;    % c1's x becomes c2's x
% y_axis1 = y_axis3;    % c1's y becomes c2's y
% z_axis1 = z_axis3;    % c1's z becomes c2's z
% 
% x_axis2 = x_axis4;    % c2's x becomes c4's x
% y_axis2 = y_axis4;    % c2's y becomes c4's y
% z_axis2 = z_axis4;    % c2's z becomes c4's z
% 
% x_axis4 = temp_x;    % c4's x takes the original x of c1
% y_axis4 = temp_y;    % c4's y takes the original y of c1
% z_axis4 = temp_z;    % c4's z takes the original z of c1
%%
...
zlim([-10 40])
%%
save('NEWmydata_pca_veh.mat', 'x_axis1', 'y_axis1', 'z_axis1', 'x_axis2', 'y_axis2', 'z_axis2', 'x_axis3', 'y_axis3', 'z_axis3', 'x_axis4', 'y_axis4', 'z_axis4');
%%
